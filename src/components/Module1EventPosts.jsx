        ...
        try {
          ...
          if (pageData.success && (pageData.draft1 || pageData.draft2)) {
            setLiveNotionDrafts(prev => ({
              ...prev,
              [selectedOccasion.id]: {
                draft1: pageData.draft1 || prev[selectedOccasion.id]?.draft1 || '',
                draft2: pageData.draft2 || prev[selectedOccasion.id]?.draft2 || '',
                rationale: pageData.rationale || prev[selectedOccasion.id]?.rationale || '',
          ...
          if (attempts >= 12) {
            clearInterval(interval);
            setNotionSyncing(false);
            setNotionStatus('Post created in Notion! Custom Agents are queued. Click "Open in Notion" to view.');
