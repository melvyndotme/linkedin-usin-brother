        ...
        try {
          ...
          if (pageData.success && (pageData.draft1 || pageData.draft2)) {
            ...
            setLiveNotionNewsDrafts(prev => ({
              ...prev,
              [newsKey]: {
                draft1: pageData.draft1,
                draft2: pageData.draft2,
                rationale: pageData.rationale,
          ...
          if (attempts >= 8) {
            clearInterval(interval);
            setNotionSyncing(false);
            setNotionStatus('Post created in Notion! Custom Agents are still processing. Click "Open in Notion" to view.');
          } else {
            setNotionStatus(`2/2 Notion Custom Agents writing in Notion (attempt ${attempts}/8)...`);
          }
        } catch (pollErr) {
