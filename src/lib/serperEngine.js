...
export async function searchSerperWithTimeframe({
  ...
  // 3. No key configured anywhere: return curated baseline with verified portal links
  return {
    isLive: false,
    hasKey: false,
    ...
    warning: "No Serper.dev API key found. Showing sample baseline with verified portal links. Please add your Serper key to search live Google News."
  };
}
